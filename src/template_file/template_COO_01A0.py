...
async def create_template_coo(date, temp_dir, company, product_id):
    ## Product Data ##
    ...
    file_name = f"{company}_{product_name_footer}_COO_01A0.pdf"
    ...
    text = "Made in the <u><b>USA</b></u> with foreign and domestic ingredients."
    ...
    # c.setFillColorRGB(0, 0, 0, 1)
    # c.drawRightString(w - 30, pfh + 6, f"{product_name_footer}_COO_01A0")
    ...
    para_text = f"{product_name}_COO_01A0"

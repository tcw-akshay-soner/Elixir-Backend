...
async def create_template_contact(date, temp_dir, company, product_id):
       ...
       file_name = "SEB_Contact Information_01A0.pdf"
       ...
       c.drawCentredString(w / 2, y, "Specialty Enzymes & Probiotics –Emergency Contact Information")
       text_width = c.stringWidth("Specialty Enzymes & Probiotics –Emergency Contact Information", "Cambria-Bold", 14)
       ...
       c.drawRightString(w - 30, pfh + 3, "SEB_Contact Information_01A0")
       c.showPage()
       c.save()
